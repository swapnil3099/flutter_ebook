...
class Page20_4 extends StatefulWidget {
  @override
  _Page20_4State createState() => _Page20_4State();
}

class _Page20_4State extends State<Page20_4> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master20_4.pdf');
