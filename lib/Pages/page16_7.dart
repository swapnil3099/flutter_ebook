...
class Page16_7 extends StatefulWidget {
  @override
  _Page16_7State createState() => _Page16_7State();
}

class _Page16_7State extends State<Page16_7> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master16_7.pdf');
