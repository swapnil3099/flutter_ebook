...
class Page22_2 extends StatefulWidget {
  @override
  _Page22_2State createState() => _Page22_2State();
}

class _Page22_2State extends State<Page22_2> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master22_2.pdf');
