...
class Page23_9 extends StatefulWidget {
  @override
  _Page23_9State createState() => _Page23_9State();
}

class _Page23_9State extends State<Page23_9> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master23_9.pdf');
