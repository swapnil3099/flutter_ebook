...
class Page8_6 extends StatefulWidget {
  @override
  _Page8_6State createState() => _Page8_6State();
}

class _Page8_6State extends State<Page8_6> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master8_6.pdf');
