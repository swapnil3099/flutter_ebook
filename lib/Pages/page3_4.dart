...
class Page3_4 extends StatefulWidget {
  @override
  _Page3_4State createState() => _Page3_4State();
}

class _Page3_4State extends State<Page3_4> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master3_4.pdf');
