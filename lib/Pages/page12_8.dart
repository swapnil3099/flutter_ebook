...
class Page12_8 extends StatefulWidget {
  @override
  _Page12_8State createState() => _Page12_8State();
}

class _Page12_8State extends State<Page12_8> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master12_8.pdf');
