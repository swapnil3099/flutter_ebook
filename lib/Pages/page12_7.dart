...
class Page12_7 extends StatefulWidget {
  @override
  _Page12_7State createState() => _Page12_7State();
}

class _Page12_7State extends State<Page12_7> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master12_7.pdf');
