...
class Page19_3 extends StatefulWidget {
  @override
  _Page19_3State createState() => _Page19_3State();
}

class _Page19_3State extends State<Page19_3> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master19_3.pdf');
