...
class Page11_4 extends StatefulWidget {
  @override
  _Page11_4State createState() => _Page11_4State();
}

class _Page11_4State extends State<Page11_4> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master11_4.pdf');
