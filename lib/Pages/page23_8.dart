...
class Page23_8 extends StatefulWidget {
  @override
  _Page23_8State createState() => _Page23_8State();
}

class _Page23_8State extends State<Page23_8> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master23_8.pdf');
