...
class Page20_6 extends StatefulWidget {
  @override
  _Page20_6State createState() => _Page20_6State();
}

class _Page20_6State extends State<Page20_6> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master20_6.pdf');
