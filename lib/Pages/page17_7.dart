...
class Page17_7 extends StatefulWidget {
  @override
  _Page17_7State createState() => _Page17_7State();
}

class _Page17_7State extends State<Page17_7> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master17_7.pdf');
