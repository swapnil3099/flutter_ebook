...
class Page16_6 extends StatefulWidget {
  @override
  _Page16_6State createState() => _Page16_6State();
}

class _Page16_6State extends State<Page16_6> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master16_6.pdf');
