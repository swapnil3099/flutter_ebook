...
class Page11_7 extends StatefulWidget {
  @override
  _Page11_7State createState() => _Page11_7State();
}

class _Page11_7State extends State<Page11_7> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master11_.pdf');
