...
class Page23_2 extends StatefulWidget {
  @override
  _Page23_2State createState() => _Page23_2State();
}

class _Page23_2State extends State<Page23_2> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master23_2.pdf');
