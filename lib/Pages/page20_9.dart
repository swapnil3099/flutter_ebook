...
class Page20_9 extends StatefulWidget {
  @override
  _Page20_9State createState() => _Page20_9State();
}

class _Page20_9State extends State<Page20_9> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master20_9.pdf');
