...
class Page17_8 extends StatefulWidget {
  @override
  _Page17_8State createState() => _Page17_8State();
}

class _Page17_8State extends State<Page17_8> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master17_8.pdf');
