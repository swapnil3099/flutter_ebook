...
class Page18_6 extends StatefulWidget {
  @override
  _Page18_6State createState() => _Page18_6State();
}

class _Page18_6State extends State<Page18_6> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master18_6.pdf');
