...
class Page3_3 extends StatefulWidget {
  @override
  _Page3_3State createState() => _Page3_3State();
}

class _Page3_3State extends State<Page3_3> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master3_3.pdf');
