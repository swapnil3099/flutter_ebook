...
class Page13_4 extends StatefulWidget {
  @override
  _Page13_4State createState() => _Page13_4State();
}

class _Page13_4State extends State<Page13_4> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master13_4.pdf');
