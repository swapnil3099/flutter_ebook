...
class Page16_4 extends StatefulWidget {
  @override
  _Page16_4State createState() => _Page16_4State();
}

class _Page16_4State extends State<Page16_4> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master16_4.pdf');
