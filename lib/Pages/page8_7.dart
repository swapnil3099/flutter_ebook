...
class Page8_7 extends StatefulWidget {
  @override
  _Page8_7State createState() => _Page8_7State();
}

class _Page8_7State extends State<Page8_7> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master8_7.pdf');
