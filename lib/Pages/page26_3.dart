...
class Page26_3 extends StatefulWidget {
  @override
  _Page26_3State createState() => _Page26_3State();
}

class _Page26_3State extends State<Page26_3> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master26_3.pdf');
