...
class Page17_5 extends StatefulWidget {
  @override
  _Page17_5State createState() => _Page17_5State();
}

class _Page17_5State extends State<Page17_5> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master17_5.pdf');
