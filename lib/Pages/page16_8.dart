...
class Page16_8 extends StatefulWidget {
  @override
  _Page16_8State createState() => _Page16_8State();
}

class _Page16_8State extends State<Page16_8> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master16_8.pdf');
