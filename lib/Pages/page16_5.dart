...
class Page16_5 extends StatefulWidget {
  @override
  _Page16_5State createState() => _Page16_5State();
}

class _Page16_5State extends State<Page16_5> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master16_5.pdf');
