...
class Page24_6 extends StatefulWidget {
  @override
  _Page24_6State createState() => _Page24_6State();
}

class _Page24_6State extends State<Page24_6> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master24_6.pdf');
