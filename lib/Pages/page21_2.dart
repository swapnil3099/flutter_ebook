...
class Page21_2 extends StatefulWidget {
  @override
  _Page21_2State createState() => _Page21_2State();
}

class _Page21_2State extends State<Page21_2> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master21_2.pdf');
