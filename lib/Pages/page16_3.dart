...
class Page16_3 extends StatefulWidget {
  @override
  _Page16_3State createState() => _Page16_3State();
}

class _Page16_3State extends State<Page16_3> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master16_3.pdf');
