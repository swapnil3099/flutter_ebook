...
class Page18_5 extends StatefulWidget {
  @override
  _Page18_5State createState() => _Page18_5State();
}

class _Page18_5State extends State<Page18_5> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master18_5.pdf');
