...
class Page18_4 extends StatefulWidget {
  @override
  _Page18_4State createState() => _Page18_4State();
}

class _Page18_4State extends State<Page18_4> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master18_4.pdf');
