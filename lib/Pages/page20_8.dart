...
class Page20_8 extends StatefulWidget {
  @override
  _Page20_8State createState() => _Page20_8State();
}

class _Page20_8State extends State<Page20_8> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master20_8.pdf');
