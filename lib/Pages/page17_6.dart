...
class Page17_6 extends StatefulWidget {
  @override
  _Page17_6State createState() => _Page17_6State();
}

class _Page17_6State extends State<Page17_6> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master17_6.pdf');
