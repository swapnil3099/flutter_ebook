...
class Page25_2 extends StatefulWidget {
  @override
  _Page25_2State createState() => _Page25_2State();
}

class _Page25_2State extends State<Page25_2> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master25_2.pdf');
