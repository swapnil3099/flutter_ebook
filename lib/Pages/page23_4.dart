...
class Page23_4 extends StatefulWidget {
  @override
  _Page23_4State createState() => _Page23_4State();
}

class _Page23_4State extends State<Page23_4> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master23_4.pdf');
