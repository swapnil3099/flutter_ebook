...
class Page13_3 extends StatefulWidget {
  @override
  _Page13_3State createState() => _Page13_3State();
}

class _Page13_3State extends State<Page13_3> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master13_3.pdf');
