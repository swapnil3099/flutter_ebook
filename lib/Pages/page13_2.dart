...
class Page13_2 extends StatefulWidget {
  @override
  _Page13_2State createState() => _Page13_2State();
}

class _Page13_2State extends State<Page13_2> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master13_2.pdf');
