...
class Page8_4 extends StatefulWidget {
  @override
  _Page8_4State createState() => _Page8_4State();
}

class _Page8_4State extends State<Page8_4> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master8_4.pdf');
