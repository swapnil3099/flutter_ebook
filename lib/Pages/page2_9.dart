...
class Page2_9 extends StatefulWidget {
  @override
  _Page2_9State createState() => _Page2_9State();
}

class _Page2_9State extends State<Page2_9> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master2_9.pdf');
