...
class Page8_5 extends StatefulWidget {
  @override
  _Page8_5State createState() => _Page8_5State();
}

class _Page8_5State extends State<Page8_5> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master8_5.pdf');
