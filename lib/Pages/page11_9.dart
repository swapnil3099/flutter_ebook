...
class Page11_9 extends StatefulWidget {
  @override
  _Page11_9State createState() => _Page11_9State();
}

class _Page11_9State extends State<Page11_9> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master11_9.pdf');
