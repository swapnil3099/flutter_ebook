...
class Page2_7 extends StatefulWidget {
  @override
  _Page2_7State createState() => _Page2_7State();
}

class _Page2_7State extends State<Page2_7> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master2_7.pdf');
