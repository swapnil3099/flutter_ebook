...
class Page12_4 extends StatefulWidget {
  @override
  _Page12_4State createState() => _Page12_4State();
}

class _Page12_4State extends State<Page12_4> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master12_4.pdf');
