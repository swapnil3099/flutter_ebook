...
class Page25_3 extends StatefulWidget {
  @override
  _Page25_3State createState() => _Page25_3State();
}

class _Page25_3State extends State<Page25_3> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master25_3.pdf');
