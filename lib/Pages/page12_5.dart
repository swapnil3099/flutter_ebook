...
class Page12_5 extends StatefulWidget {
  @override
  _Page12_5State createState() => _Page12_5State();
}

class _Page12_5State extends State<Page12_5> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master12_5.pdf');
