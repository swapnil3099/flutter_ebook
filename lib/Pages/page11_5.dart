...
class Page11_5 extends StatefulWidget {
  @override
  _Page11_5State createState() => _Page11_5State();
}

class _Page11_5State extends State<Page11_5> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master11_5.pdf');
