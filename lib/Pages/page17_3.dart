...
class Page17_3 extends StatefulWidget {
  @override
  _Page17_3State createState() => _Page17_3State();
}

class _Page17_3State extends State<Page17_3> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master17_3.pdf');
