...
class Page22_4 extends StatefulWidget {
  @override
  _Page22_4State createState() => _Page22_4State();
}

class _Page22_4State extends State<Page22_4> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master22_4.pdf');
