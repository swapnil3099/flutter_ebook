...
class Page11_6 extends StatefulWidget {
  @override
  _Page11_6State createState() => _Page11_6State();
}

class _Page11_6State extends State<Page11_6> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master11_6.pdf');
