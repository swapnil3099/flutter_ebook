...
class Page26_7 extends StatefulWidget {
  @override
  _Page26_7State createState() => _Page26_7State();
}

class _Page26_7State extends State<Page26_7> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master26_7.pdf');
