...
class Page23_7 extends StatefulWidget {
  @override
  _Page23_7State createState() => _Page23_7State();
}

class _Page23_7State extends State<Page23_7> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master23_7.pdf');
