...
class Page24_7 extends StatefulWidget {
  @override
  _Page24_7State createState() => _Page24_7State();
}

class _Page24_7State extends State<Page24_7> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master24_7.pdf');
