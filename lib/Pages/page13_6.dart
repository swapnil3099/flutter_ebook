...
class Page13_6 extends StatefulWidget {
  @override
  _Page13_6State createState() => _Page13_6State();
}

class _Page13_6State extends State<Page13_6> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master13_6.pdf');
