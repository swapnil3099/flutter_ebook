...
class Page26_5 extends StatefulWidget {
  @override
  _Page26_5State createState() => _Page26_5State();
}

class _Page26_5State extends State<Page26_5> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master26_5.pdf');
