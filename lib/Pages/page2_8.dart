...
class Page2_8 extends StatefulWidget {
  @override
  _Page2_8State createState() => _Page2_8State();
}

class _Page2_8State extends State<Page2_8> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master2_8.pdf');
