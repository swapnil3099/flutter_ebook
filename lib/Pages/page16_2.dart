...
class Page16_2 extends StatefulWidget {
  @override
  _Page16_2State createState() => _Page16_2State();
}

class _Page16_2State extends State<Page16_2> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master16_2.pdf');
