...
class Page26_8 extends StatefulWidget {
  @override
  _Page26_8State createState() => _Page26_8State();
}

class _Page26_8State extends State<Page26_8> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master26_8.pdf');
