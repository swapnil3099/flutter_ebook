...
class Page20_5 extends StatefulWidget {
  @override
  _Page20_5State createState() => _Page20_5State();
}

class _Page20_5State extends State<Page20_5> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master20_5.pdf');
