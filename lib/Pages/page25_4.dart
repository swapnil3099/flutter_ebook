...
class Page25_4 extends StatefulWidget {
  @override
  _Page25_4State createState() => _Page25_4State();
}

class _Page25_4State extends State<Page25_4> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master25_4.pdf');
