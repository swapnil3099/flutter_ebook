...
class Page12_9 extends StatefulWidget {
  @override
  _Page12_9State createState() => _Page12_9State();
}

class _Page12_9State extends State<Page12_9> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master12_9.pdf');
