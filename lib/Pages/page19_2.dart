...
class Page19_2 extends StatefulWidget {
  @override
  _Page19_2State createState() => _Page19_2State();
}

class _Page19_2State extends State<Page19_2> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master19_2.pdf');
