...
class Page8_20 extends StatefulWidget {
  @override
  _Page8_20State createState() => _Page8_20State();
}

class _Page8_20State extends State<Page8_20> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master8_.pdf');
