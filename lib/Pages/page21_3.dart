...
class Page21_3 extends StatefulWidget {
  @override
  _Page21_3State createState() => _Page21_3State();
}

class _Page21_3State extends State<Page21_3> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master21_3.pdf');
