...
class Page18_3 extends StatefulWidget {
  @override
  _Page18_3State createState() => _Page18_3State();
}

class _Page18_3State extends State<Page18_3> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master18_3.pdf');
