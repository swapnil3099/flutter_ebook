...
class Page8_8 extends StatefulWidget {
  @override
  _Page8_8State createState() => _Page8_8State();
}

class _Page8_8State extends State<Page8_8> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master8_8.pdf');
