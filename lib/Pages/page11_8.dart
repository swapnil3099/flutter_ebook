...
class Page11_8 extends StatefulWidget {
  @override
  _Page11_8State createState() => _Page11_8State();
}

class _Page11_8State extends State<Page11_8> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master11_8.pdf');
