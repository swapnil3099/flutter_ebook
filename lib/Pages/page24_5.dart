...
class Page24_5 extends StatefulWidget {
  @override
  _Page24_5State createState() => _Page24_5State();
}

class _Page24_5State extends State<Page24_5> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master24_5.pdf');
