...
class Page8_9 extends StatefulWidget {
  @override
  _Page8_9State createState() => _Page8_9State();
}

class _Page8_9State extends State<Page8_9> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master8_9.pdf');
