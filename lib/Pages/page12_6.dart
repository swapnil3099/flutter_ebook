...
class Page12_6 extends StatefulWidget {
  @override
  _Page12_6State createState() => _Page12_6State();
}

class _Page12_6State extends State<Page12_6> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master12_6.pdf');
