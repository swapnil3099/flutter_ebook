...
class Page20_7 extends StatefulWidget {
  @override
  _Page20_7State createState() => _Page20_7State();
}

class _Page20_7State extends State<Page20_7> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master20_7.pdf');
