...
class Page13_5 extends StatefulWidget {
  @override
  _Page13_5State createState() => _Page13_5State();
}

class _Page13_5State extends State<Page13_5> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master13_5.pdf');
