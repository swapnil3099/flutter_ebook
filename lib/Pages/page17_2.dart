...
class Page17_2 extends StatefulWidget {
  @override
  _Page17_2State createState() => _Page17_2State();
}

class _Page17_2State extends State<Page17_2> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master17_2.pdf');
