...
class Page22_3 extends StatefulWidget {
  @override
  _Page22_3State createState() => _Page22_3State();
}

class _Page22_3State extends State<Page22_3> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master22_3.pdf');
