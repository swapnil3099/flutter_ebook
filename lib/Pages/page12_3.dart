...
class Page12_3 extends StatefulWidget {
  @override
  _Page12_3State createState() => _Page12_3State();
}

class _Page12_3State extends State<Page12_3> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master12_3.pdf');
