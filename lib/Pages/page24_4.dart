...
class Page24_4 extends StatefulWidget {
  @override
  _Page24_4State createState() => _Page24_4State();
}

class _Page24_4State extends State<Page24_4> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master24_4.pdf');
