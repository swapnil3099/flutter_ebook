...
class Page18_2 extends StatefulWidget {
  @override
  _Page18_2State createState() => _Page18_2State();
}

class _Page18_2State extends State<Page18_2> {
  @override
...
class _AfterSplashState extends State<AfterSplash> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromAsset('assets/pdf/master18_2.pdf');
